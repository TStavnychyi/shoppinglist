...
import com.stavnychyy.shoppinglist.shoppinglistdetails.view.ShoppingListDetailsFragment.Companion.ADDED_SHOPPING_LIST_ITEM
...
class AddShoppingListItemBottomSheet : BaseBottomSheetDialogFragment() {
    ...
    private fun createNewItem() {
        val listItem = AddingShoppingListItemResult(
          view_item_name.getString(), view_item_additional_info.getString())
